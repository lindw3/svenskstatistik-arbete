...
## {.tabset .tabset-pills}
### Källor
- Arbetstid: Klicka här 
<br>
- Anställning: Klicka här
<br>
- Arbetsfrånvaro: Klicka här
<br>
- Löner utifrån sektor: Klicka här
<br>
- Löner utifrån näringsgren: Klicka här
<br>
- Löner utifrån utbildning: Klicka här
<br>
- Löner utifrån ålder: Klicka här
<br>
- Sysselsättning: Har utgått från SCB:s statistikdatabas sedan 2025.
<br>
